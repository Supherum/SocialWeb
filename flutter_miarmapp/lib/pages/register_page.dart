    ...
    return Scaffold(
      ...
      body: BlocConsumer<RegisterBloc,RegisterState>(
        listenWhen: (context,state){
          return state is RegisterSuccessState || state is RegisterErrorState || state is RegisterImageErrorState || state is RegisterDateErrorState;
          ...
          if(state is RegisterSuccessState){
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context)=>  HomePageBloc()));
        ...
        buildWhen:(context,state){
          return state is RegisterDateSuccessState || state is RegisterImageSuccessState || state is LoginInitialState || state is LoginLoadingState;
        },
        builder: (context,state){
          ...
          }else if (state is RegisterImageSuccessState && state is RegisterDateSuccessState){
            return _formBuild ('ENGLISH',context);
          }          
          else{
            return _formBuild ('ENGLISH',context);
                  ...
                  Column(children: [
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () => {
                         BlocProvider.of<RegisterBloc>(context).add(const SelectImageEvent(ImageSource.gallery))
                        },
                        child: Row(
                      ...
                      children: [
                        ...
                        SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: (){
                               BlocProvider.of<RegisterBloc>(context).add(SelectDateEvent(context));
                              },
                    ...
                    Container(
                        ...
                        child: ElevatedButton(
                          onPressed: (){
                           ...
                           // BlocProvider.of<RegisterBloc>(context).add(DoRegisterEvent(resource, registerDto));
                          },
